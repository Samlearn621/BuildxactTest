...
* Data formats in the json and the csv are different but there are fixed
* It is allowed to add/remove json and csv file without any code changes
* Appsetting file allows disable any data source
* Appsetting file allows change currency type

## Future work
* Fixing reading csv files
* Adding logging
* Code clean up
